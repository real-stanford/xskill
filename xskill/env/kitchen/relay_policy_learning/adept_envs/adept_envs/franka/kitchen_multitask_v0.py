...
class KitchenV0(robot_env.RobotEnv):
    ...
    def __init__(self, 
        ...
        self.use_sphere_agent = use_sphere_agent
        if use_abs_action:
        ...
        os.path.dirname(__file__),
        '../franka/assets/franka_kitchen_jntpos_act_ab_sphere.xml')
...
class KitchenTaskRelaxV1(KitchenV0):
    ...
    def __init__(self, use_abs_action=False,use_sphere_agent=False):
        super(KitchenTaskRelaxV1, self).__init__(
            use_abs_action=use_abs_action,use_sphere_agent=use_sphere_agent)
